...
train_dataset = dict(
    ...
    classes=classes,
    ann_files=[data_root + 'db4_train_A.json', data_root + 'db4_train_B.json',
               data_root + 'db4_train_C.json', data_root + 'db4_train_D.json'],
...
data = dict(
    ...
    val=dict(
        ...
        img_prefix=data_root + 'images/',
        classes=classes,
        ann_files=[data_root + 'db4_test_A.json', data_root + 'db4_test_B.json',
                   data_root + 'db4_test_C.json', data_root + 'db4_test_D.json'],
