...
fundamental_matrices = {(0, 1): [[4.45897814e-07, -2.79773902e-07, -1.15397430e-02],
                                 [-1.93436595e-06, 1.70730416e-08, 7.01132265e-04],
                                 [1.19589770e-02, -5.06732925e-06, -1.89748220e-01]]}
size = (544, 544)
model = dict(
    backbone=dict(type='MVDarknet', depth=53, out_indices=(3, 4, 5), epipolar_combination_block=-2,
                  fundamental_matrices=fundamental_matrices, input_size=size),
