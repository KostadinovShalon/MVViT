...
custom_imports = dict(imports=['mv_extension.models.backbones.full_mv_darknet'], allow_failed_imports=False)

size = (544, 544)
model = dict(
    backbone=dict(type='MVFullDarknet', depth=53, out_indices=(3, 4, 5), combination_block=-2,
                  input_size=size),
