...
custom_imports = dict(imports=['mv_extension.models.backbones.full_mv_transformer_darknet'], allow_failed_imports=False)
...
data = dict(
    ...
    train=dict(
        ...
        # 'data/db4/db4_train_B.json', 'data/db4/db4_train_D.json'],
    ...
    val=dict(
        ...
        # 'data/db4/db4_test_B.json', 'data/db4/db4_test_D.json'],
