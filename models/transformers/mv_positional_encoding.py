...
class MVSinePositionalEncoding(BaseModule):
    """MV Position encoding with sine and cosine functions.

    See `End-to-End Object Detection with Transformers
    <https://arxiv.org/pdf/2005.12872>`_ for details.

    Args:
        num_feats (int): THE FINAL FEATURE DIMENSION The feature dimension for each position
    ...
    def __init__(self,
                 ...
                 offset=0.,
                 init_cfg=None):
        super(MVSinePositionalEncoding, self).__init__(init_cfg)
        if normalize:
    ...
    def forward(self, mask):
        ...
        v_embed = not_mask.cumsum(1, dtype=torch.float32)
