...
from mmdet.models import HEADS, DeformableDETRHead
from mmdet.models.utils.transformer import inverse_sigmoid


@HEADS.register_module()
class MVDeformableDETRHead(DeformableDETRHead):
    ...
    def forward(self, mvmlvl_feats, img_metas):
        """Forward function.
        ...
        for v, mlvl_feats in enumerate(mvmlvl_feats):
            ...
            for img_id in range(batch_size):
                img_h, img_w, _ = img_metas[img_id]['img_shape'][v]
